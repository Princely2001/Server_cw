...
<body>
    ...
    <div class="forgot-shell">
        <div class="left-panel">
            ...
            <p>
                Enter your university email and we’ll send you a secure reset link so you can regain access to your account.
            </p>

            <div class="feature-list">
                <div class="feature-item">
                    <div class="feature-icon">📧</div>
                    <span>Receive a secure password reset link</span>
                </div>
                <div class="feature-item">
                    <div class="feature-icon">🔒</div>
                    <span>Recover access to your alumni account safely</span>
                </div>
                <div class="feature-item">
                    <div class="feature-icon">⚡</div>
                    <span>Fast and simple account recovery flow</span>
                </div>
            </div>
        </div>
        ...
        <div class="right-panel">
            <div class="form-card">
                ...
                <p class="form-subtitle">Enter your university email to receive a password reset link.</p>
                ...
                <a href="<?= site_url('auth/login'); ?>" class="back-link">Back to Login</a>

                <div class="helper-text">
                    Make sure you enter the same email used for your alumni account.
                </div>
            </div>
        </div>
    </div>
