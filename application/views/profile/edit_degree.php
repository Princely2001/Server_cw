...
<body style="background-color: #f4f4f4;">
    ...
    <div class="section">
        ...
        <?= form_open('profile/edit_degree/'.$degree->id) ?>
            ...
            <input type="text" name="degree_name" value="<?= html_escape($degree->degree_name) ?>" required>

            <label>University/Course URL</label>
            <input type="url" name="university_url" value="<?= html_escape($degree->university_url) ?>" required>

            <label>Completion Date</label>
            <input type="date" name="completion_date" value="<?= html_escape($degree->completion_date) ?>" required>
