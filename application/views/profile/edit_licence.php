...
<body style="background-color: #f4f4f4;">
    ...
    <div class="section">
        ...
        <?= form_open('profile/edit_licence/'.$licence->id) ?>
            ...
            <input type="text" name="licence_name" value="<?= html_escape($licence->licence_name) ?>" required>

            <label>Awarding Body URL</label>
            <input type="url" name="awarding_body_url" value="<?= html_escape($licence->awarding_body_url) ?>" required>

            <label>Award Date</label>
            <input type="date" name="completion_date" value="<?= html_escape($licence->completion_date) ?>" required>
